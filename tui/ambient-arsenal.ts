...
export const AMBIENT_ARSENAL: AmbientSeed[] = [
  ...
  { id: "marbles", label: "slow marbles", slot: "d4", why: "Pitch-darkened marbles roll across wood, then leave ten seconds of space.", expect: { metric: "low", dir: "up" },
    code: '~d.(\\d4, \\instrument, \\texture, \\buf, ~t.(\\marbles), \\delta, Pseq([1.5, 0.6, 2.8, 1, 6, 0.75, 9], inf), \\dur, 5, \\len, Pwhite(4.2, 6), \\att, 0.018, \\rel, 0.9, \\start, Pwhite(0, 0.18), \\rate, Pwrand([0.38, 0.48, 0.62], [0.2, 0.55, 0.25], inf), \\hp, 45, \\lp, 5200, \\sub, Pwhite(0.2, 0.34), \\subfreq, Pwhite(38, 54), \\amp, Pwhite(0.13, 0.19), \\pan, Pbrown(-0.65, 0.65, 0.16), \\send, 0.56)' },
  ...
  { id: "halo", label: "breathing harmonic halo", slot: "d5", why: "The current harmony pulses through a warm, moving halo.", expect: { metric: "mid", dir: "up" },
    ...
    code: '~d.(\\d5, \\instrument, \\pad, \\dur, 24, \\midinote, Pseq([[62, 69, 76, 80], [64, 71, 78, 81], [66, 73, 80, 85]], inf), \\att, 9, \\sus, 14, \\rel, 12, \\cutoff, Pseg([800, 1900, 1050], 72, repeats: inf), \\duck, 0, \\amp, 0.032, \\send, 0.95)' },
