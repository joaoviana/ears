...
import { ask } from "../agent.ts"; import { roster } from "../djs.ts"; import { makeBase } from "../seed.ts";
...
let slots = 0, ideas = 0, up = 0;
for (let r = 0; r < rounds; r++) {
  await ask({ dj, skills: [], slots: base.slots, report, note: "", history: [], context: `${base.bpm} BPM, key ${base.key} (bass root midinote ${base.root})` },
    (o) => {
